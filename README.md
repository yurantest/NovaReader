...
bashsudo chmod +x /opt/NovaReader/tts/piper/piper
Замените /opt/NovaReader на путь к вашей папке с программой, если он отличается.
Это нужно из-за особенностей копирования файлов с правами root в некоторых файловых менеджерах — исполняемый бит на бинарнике может теряться. При установке в обычную папку пользователя (например, в домашнюю директорию) этот шаг не требуется.
---
